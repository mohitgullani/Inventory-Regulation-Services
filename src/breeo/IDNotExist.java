 ...
 * @author HP
 */
public class IDNotExist extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Shop ID Not Exist...!!");
...
static int xx,yy;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IDNotExist.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new IDNotExist().setVisible(true);
            }
        });
    }
