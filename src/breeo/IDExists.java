...
public class IDExists extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("This ID already exists");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(28, 170, 510, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IDExists.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
