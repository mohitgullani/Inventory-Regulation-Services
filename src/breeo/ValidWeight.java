 ...
 * @author HP
 */
public class ValidWeight extends javax.swing.JFrame {
...
static int xx,yy;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ValidWeight.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ValidWeight().setVisible(true);
            }
        });
    }
