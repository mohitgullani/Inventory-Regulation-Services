 ...
 * @author HP
 */
public class NotRegisteredContact extends javax.swing.JFrame {

    /**
     * Creates new form NotRegisteredContact
     */
    public NotRegisteredContact() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Sorry, Number not Registered");
...
static int xx,yy;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NotRegisteredContact.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NotRegisteredContact().setVisible(true);
            }
        });
    }
